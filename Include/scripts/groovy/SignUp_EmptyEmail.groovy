...
class SignUp_EmptyEmail {
	...
	def Enter_empty_Email( ) {
		WebUI.setEncryptedText(findTestObject('Page_Register/input__email'), '')
	}
	...
	def Tap_register_button() {
		WebUI.click(findTestObject('Page_Register/Button__register'))
		WebUI.delay(5)
		WebUI.verifyElementText(findTestObject('Verification/Signup_ErrorPleaseProvideValidEmailAddress'), 'Error: Please provide a valid email address.')
	}
}